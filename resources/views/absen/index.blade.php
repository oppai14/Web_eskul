                ...
                <tbody id="isi">
                    ...
                    @foreach ($absenList as $data)
                        <tr>
                            ...
                            <td>{{ $data->nama  }}</td>
                            <td>{{ $data->kelas }}</td>
                            <td><a href="{{ route('absen.edit', $absenList->id) }}" class="btn btn-warning m-1 "><i class="bi bi-pencil-square"></i></a>
                                <form action="{{ route('absen.destroy', $absenList->id) }}" method="post" style="display: inline">
                                    @csrf
                                    @method('DELETE')
